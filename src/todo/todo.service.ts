...
export class TodoService {
  ...
  create(title: string) {
    ...
    return this.todoRepository.save(todo); // Save the Todo instance to the database.
  }
  ...
  async update(id: number, isCompleted: boolean) {
    ...
    if (todo) {
      ...
      return this.todoRepository.save(todo); // Save the updated Todo item to the database.
    }
